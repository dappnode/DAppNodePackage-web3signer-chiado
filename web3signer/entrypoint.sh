...
case "$ETH2_CLIENT" in
"prysm")
  ETH2_CLIENT_DNS="validator.prysm-chiado.dappnode"
  export BEACON_NODE_API="http://beacon-chain.prysm-chiado.dappnode:3500"
  export CLIENT_API="http://validator.prysm-chiado.dappnode:3500"
